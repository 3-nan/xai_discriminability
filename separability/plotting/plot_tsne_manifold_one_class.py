...
with open(filepath) as file:
    ...
    resultdir = "../results/tsne_manifold_one_class"

    args = configs["quantifications"][0]["tsne_manifold_one_class"]["args"]
    print(args["percentages"])

    train_embedding = np.load(os.path.join(resultdir, "tsne_embedding_layer_50.npy"))
    targets = np.load(os.path.join(resultdir, "targets_layer_50.npy"))
